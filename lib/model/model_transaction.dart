...
ModelTransaction modelTransactionFromJson(String str) => ModelTransaction.fromJson(json.decode(str));

String modelTransactionToJson(ModelTransaction data) => json.encode(data.toJson());
