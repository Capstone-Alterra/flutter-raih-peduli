...
class _CustomFloatingButtonState extends State<CustomFloatingButton> {
  ...
  Widget build(BuildContext context) {
    final overlayProvider = Provider.of<AccessVolunteerViewModel>(context);
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: SvgPicture.asset(
                          'assets/donasi.svg', // Gantilah dengan path SVG yang sesuai
                  ...
                  child: Row(
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: SvgPicture.asset(
                          'assets/relawan.svg', // Gantilah dengan path SVG yang sesuai
                          height: 24.0, // Sesuaikan dengan kebutuhan
                        ),
                      ),
                    ],
